...
and relative or metric projection settings. Its
...
manifests are no longer part of current state and the authorized prune list may
be deleted.
...
Nullable fields use the larger of their numeric/object token and `null`.
