...
class DepthMapProcessor:
    ...
    def _generate_depth_map_files_for_identity(
        ...
        *,
        ...
        raw_store = self._open_or_reset_raw_store(
            raw_dir,
            canonical_dir,
            metric_dir,
            frame_names=frame_names,
        ...
        if geometry_mode == "relative":
            existing = self._restore_relative_geometry_if_available(
    ...
    def _open_or_reset_raw_store(
        ...
        *,
        ...
        try:
            return self._open_raw_store_if_present(
                raw_dir,
                frame_names=frame_names,
                semantic_fingerprint=semantic_fingerprint,
                requested_dtype=requested_dtype,
    ...
    def _restore_relative_geometry_if_available(
        self,
        *,
        skip_global_cache: bool,
        video_path: Any,
        ...
        if restored is not None:
            if raw_store is not None and not keep_intermediates:
        ...
        return self._try_reuse_local_canonical_stage(
            raw_store,
            final_state,
            frame_names,
            canonical_dir,
    ...
    def _raw_semantic_fingerprint(
        ...
        fingerprint["camera_model"] = str(getattr(self.depth_estimator, "camera_model", "none"))
        if self._supports_sequence_depth():
    ...
    def _write_v2_raw_batch(
        ...
        raw_store.write_batch(batch_names, result)
        return raw_store
    ...
    def _determine_input_size(
        ...
        try:
            ...
            return self._auto_determine_input_size(frame_w, frame_h, 0.0)
